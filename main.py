...
░░░╚═╝░░░╚══════╝╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝  ╚═════╝░░╚════╝░░╚════╝░╚═╝╚═╝░░╚═╝╚══════╝
    ...
    print_border("VEERA SOCIAL", Fore.GREEN)
...
async def run_community(language: str):
    from scripts.community import run_community as community_run
    await community_run(language)

async def run_discord(language: str):
    from scripts.discord import run_discord as discord_run
    await discord_run(language)
